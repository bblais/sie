# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/04_distributions.ipynb.

# %% auto 0
__all__ = ['logfact', 'tpdf', 'logtpdf', 'loguniformpdf', 'logjeffreyspdf', 'logcauchypdf', 'loghalfcauchypdf',
           'loghalfnormalpdf', 'lognormalpdf', 'logexponpdf2', 'logbernoullipdf', 'logbetapdf', 'logexponpdf',
           'StudentT', 'Normal', 'LogNormal', 'Exponential', 'HalfCauchy', 'HalfNormal', 'Uniform', 'Jeffreys',
           'Cauchy', 'Beta', 'Bernoulli', 'UniformLog']

# %% ../notebooks/04_distributions.ipynb 1
from fastcore.utils import patch

# %% ../notebooks/04_distributions.ipynb 2
